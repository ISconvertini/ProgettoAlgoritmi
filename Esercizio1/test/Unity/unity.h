 ...
 *-------------------------------------------------------
 * All options described below should be passed as a compiler flag to all files using Unity. If you must add #defines, place them BEFORE the #inc above.
 ...
 * Test Cases
 *     - define UNITY_SUPPORT_TEST_CASES to inc the TEST_CASE macro, though really it's mostly about the runner generator script
